...
export const CARDS: Record<CardId, CardDef> = {
  ...
  card_score_dice: {
    ...
    type: 'scoring',
    name: 'Arsenal',
    description: 'Al final: +2 PV por cada dado a partir del tercero.',
    cost: 6,
    effect: { kind: 'endScore', per: 'dice', from: 3, pv: 2 },
  },
  card_score_gold: {
    id: 'card_score_gold',
    type: 'scoring',
    name: 'Tesoro',
    description: 'Al final: +1 PV por cada 4 oro.',
    cost: 5,
    effect: { kind: 'endScore', per: 'gold', every: 4, pv: 1 },
  },
  card_reroll: {
    id: 'card_reroll',
    type: 'dice',
